...
public class StackMenu extends JPanel{
    ...
    public StackMenu(){
        ...
        titled=BorderFactory.createTitledBorder(titled,"    STACK MENU    ",TitledBorder.CENTER,TitledBorder.DEFAULT_JUSTIFICATION,
                new Font("Callibri",Font.PLAIN,16),Color.WHITE);
        ...
        pushPanel.setLayout(new FlowLayout());
        ...
        pushPanel.setBackground(new Color(193,193,193,100));
        ...
        popPanel.setBackground(new Color(193,193,193,100));
