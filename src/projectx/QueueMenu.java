...
public class QueueMenu extends JPanel{
    ...
    public QueueMenu(){
        ...
        titled=BorderFactory.createTitledBorder(titled,"    QUEUE MENU    ",TitledBorder.CENTER,TitledBorder.DEFAULT_JUSTIFICATION,
                new Font("Callibri",Font.PLAIN,16),Color.WHITE);        Border line=BorderFactory.createLineBorder(Color.darkGray);
        ...
        insertPanel.setBackground(new Color(193,193,193,100));
        ...
        deletePanel.setBackground(new Color(193,193,193,100));
        ...
        randomPanel.setBackground(new Color(193,193,193,100));
        ...
        undoPanel.setBackground(new Color(193,193,193,100));
        qBox.add(undoPanel);
        ...
        resetPanel.setBackground(new Color(193,193,193,100));
        qBox.add(resetPanel);
